...
public class SlidingPaneLayout extends ViewGroup
{
        ...
        for (int i = 0; i < childCount; ++i) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    final int mSlideRange = Math.min(n7, n5 - paddingRight - this.mOverhangSize) - n6 - (layoutParams.leftMargin + layoutParams.rightMargin);
    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        for (int i = 0; i < childCount; ++i) {
            ...
            if (child.getVisibility() == 8) {
                ...
                final int n6 = layoutParams.leftMargin + layoutParams.rightMargin;
                int n7;
                if (layoutParams.width == -2) {
                    n7 = View$MeasureSpec.makeMeasureSpec(size - n6, Integer.MIN_VALUE);
                }
                else if (layoutParams.width == -1) {
                    n7 = View$MeasureSpec.makeMeasureSpec(size - n6, 1073741824);
                }
                else {
                ...
                if (layoutParams.height == -2) {
                    n8 = View$MeasureSpec.makeMeasureSpec(n3, Integer.MIN_VALUE);
                }
                else if (layoutParams.height == -1) {
                    n8 = View$MeasureSpec.makeMeasureSpec(n3, 1073741824);
                }
                else {
        ...
        if (mCanSlide || n4 > 0.0f) {
            final int n9 = size - this.mOverhangSize;
            for (int j = 0; j < childCount; ++j) {
                ...
                if (child2.getVisibility() != 8) {
                    ...
                    if (child2.getVisibility() != 8) {
                        ...
                        if (mCanSlide && child2 != this.mSlideableView) {
                            if (layoutParams2.width < 0 && (measuredWidth2 > n9 || layoutParams2.weight > 0.0f)) {
                                int n10;
                                if (b) {
                                    if (layoutParams2.height == -2) {
                                        n10 = View$MeasureSpec.makeMeasureSpec(n3, Integer.MIN_VALUE);
                                    }
                                    else if (layoutParams2.height == -1) {
                                        n10 = View$MeasureSpec.makeMeasureSpec(n3, 1073741824);
                                    }
                                    else {
                                        n10 = View$MeasureSpec.makeMeasureSpec(layoutParams2.height, 1073741824);
                                    }
                                }
                                else {
                                    n10 = View$MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), 1073741824);
                                }
                                child2.measure(View$MeasureSpec.makeMeasureSpec(n9, 1073741824), n10);
                            }
                        }
                            ...
                            if (mCanSlide) {
                                final int n12 = size - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                final int measureSpec = View$MeasureSpec.makeMeasureSpec(n12, 1073741824);
                                if (measuredWidth2 != n12) {
                                    child2.measure(measureSpec, n11);
                                }
                            }
                            else {
                                child2.measure(View$MeasureSpec.makeMeasureSpec(measuredWidth2 + (int)(layoutParams2.weight * Math.max(0, n5) / n4), 1073741824), n11);
                            }
                        }
                    }
                }
    ...
    private class DragHelperCallback extends Callback
    {
        ...
        public int clampViewPositionHorizontal(final View view, final int n, final int n2) {
            final int n3 = SlidingPaneLayout.this.getPaddingLeft() + ((LayoutParams)SlidingPaneLayout.this.mSlideableView.getLayoutParams()).leftMargin;
            return Math.min(Math.max(n, n3), n3 + SlidingPaneLayout.this.mSlideRange);
        }
