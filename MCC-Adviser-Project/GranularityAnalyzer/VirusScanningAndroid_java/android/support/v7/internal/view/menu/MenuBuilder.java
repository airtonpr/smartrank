...
public class MenuBuilder implements SupportMenu
{
    ...
    private void setShortcutsVisibleInner(final boolean b) {
        ...
        if (!b || this.mResources.getConfiguration().keyboard == mShortcutsVisible || !this.mResources.getBoolean(R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) {
    ...
    public boolean performItemAction(final MenuItem menuItem, final int n) {
        ...
        if (menuItemImpl == null || !menuItemImpl.isEnabled()) {
            ...
            if (menuItemImpl.hasCollapsibleActionView()) {
                ...
                invoke |= this.dispatchSubMenuSelected(subMenuBuilder);
                if (!invoke) {
                    this.close(true);
                    return invoke;
                }
    ...
    {
        boolean onMenuItemSelected(MenuBuilder p0, MenuItem p1);
    ...
    {
        boolean invokeItem(MenuItemImpl p0);
    }
}
