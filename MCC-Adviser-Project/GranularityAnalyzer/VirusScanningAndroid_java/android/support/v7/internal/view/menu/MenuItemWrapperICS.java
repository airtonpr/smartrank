...
public class MenuItemWrapperICS extends BaseMenuWrapper<MenuItem> implements SupportMenuItem
{
    ...
    final boolean checkActionProviderOverrideVisibility() {
        final boolean mLastRequestVisible = this.mLastRequestVisible;
        boolean b = false;
        if (mLastRequestVisible) {
            final ActionProvider supportActionProvider = this.getSupportActionProvider();
            b = false;
            if (supportActionProvider != null) {
                final boolean overridesItemVisibility = supportActionProvider.overridesItemVisibility();
                b = false;
                if (overridesItemVisibility) {
                    final boolean visible = supportActionProvider.isVisible();
                    b = false;
                    if (!visible) {
