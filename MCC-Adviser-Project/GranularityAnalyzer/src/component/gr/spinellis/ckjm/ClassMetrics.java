...
public class ClassMetrics {
	...
	private String name;
	private boolean isNotOffloadableClass;

    /** Default constructor. */
    ClassMetrics(String name) {
    	this.name = name;
	wmc = 0;
	noc = 0;
	cbo = 0;
    ...
    public void setEfferentCoupledClasses(HashSet<String> efferentCoupledClasses) {
		this.efferentCoupledClasses = efferentCoupledClasses;
	}
    ...
    public HashSet<String> getAfferentCoupledClasses() {
		return afferentCoupledClasses;
	}

	public void setAfferentCoupledClasses(HashSet<String> afferentCoupledClasses) {
	...
	public void setIsNotOffloadable(boolean notOffloadableClass) {
		this.isNotOffloadableClass = notOffloadableClass;
	}

	public boolean isNotOffloadableClass() {
		return isNotOffloadableClass;
	}

	public static boolean isAndroidClass(String s) {
			return (s.startsWith("android."));
	}
