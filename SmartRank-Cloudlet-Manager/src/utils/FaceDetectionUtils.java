...
//	private static String ROOT_PATH = ""; //TO DEPLOY
	...
	private static final String CASCADE_FILE = ROOT_PATH+PATTERN_DATA_PATH+"haarcascade_frontalface_alt.xml";
...
//	  
	...
	public static List<String> dedectFacesCropAndSave(String originalImage) {
		...
		for (int i = 0; i < total; i++) {
			...
			imageNames.add(
					CloudletUtils.cropAndSaveImage(DETECTED_IMAGES_DIR, originalImage, "jpg", r.x()
	...
	public static List<CvRect> dedectFacesOnly(String originalImage) {
		...
		IplImage origImg = cvLoadImage(RECEIVED_IMAGES_DIR + originalImage);
