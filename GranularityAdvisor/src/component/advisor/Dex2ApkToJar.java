...
public class Dex2ApkToJar {
    ...
    public static void doFile(File srcDex) throws IOException {
        doFile(srcDex, new File(srcDex.getParentFile(), FilenameUtils.getBaseName(srcDex.getName()) + ".jar"));
    }
    ...
    public static void main(String... args) {
        ...
        for (String file : args) {
            ...
            final File gen = new File(dex.getParentFile(), FilenameUtils.getBaseName(file) + ".jar");
            System.out.println(dex + " -> " + gen);
            try {
                doFile(dex, gen);
            } catch (Exception e) {
                containsError = true;
