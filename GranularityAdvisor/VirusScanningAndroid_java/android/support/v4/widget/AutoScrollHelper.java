...
public abstract class AutoScrollHelper implements View$OnTouchListener
{
    ...
    public boolean onTouch(final View view, final MotionEvent motionEvent) {
        boolean mNeedsCancel = true;
        if (!this.mEnabled) {
            return false;
        }
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            case 0: {
                this.mNeedsCancel = mNeedsCancel;
                this.mAlreadyDelayed = false;
            }
            case 2: {
                this.mScroller.setTargetVelocity(this.computeTargetVelocity(0, motionEvent.getX(), view.getWidth(), this.mTarget.getWidth()), this.computeTargetVelocity((int)(mNeedsCancel ? 1 : 0), motionEvent.getY(), view.getHeight(), this.mTarget.getHeight()));
